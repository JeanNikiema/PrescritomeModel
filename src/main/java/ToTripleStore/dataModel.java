...
public class dataModel {
	...
	public ModelBuilder PropertyHasGroup(ModelBuilder builder){
		...
		.add(RDFS.LABEL, HasGroupNameEN)
		.add(RDFS.LABEL, HasGroupNameFR);	
		return builder;
	}
	...
	public ModelBuilder PropertyHasAdress(ModelBuilder builder){
		...
		.add(RDF.TYPE, RDF.PROPERTY)
		.add(RDFS.LABEL, HasAdressNameEN)
		.add(RDFS.LABEL, HasAdressNameFR);	
		return builder;
	}
	//3
	...
	public ModelBuilder PropertyHasFacility(ModelBuilder builder){
		builder.subject(HasFacility)
		.add(RDF.TYPE, RDF.PROPERTY)
		.add(RDFS.LABEL, HasFacilityNameEN)
		.add(RDFS.LABEL, HasFacilityNameFR);	
		return builder;
	}
	...
	public ModelBuilder PropertyHasDeathInformation(ModelBuilder builder){
		builder.subject(HasDeathInformation)
		.add(RDF.TYPE, RDF.PROPERTY)
		.add(RDFS.LABEL, HasDeathInformationNameEN)
		.add(RDFS.LABEL, HasDeathInformationNameFR);	
		return builder;
	}
	...
	public ModelBuilder PropertyCausedBy(ModelBuilder builder){
		...
		.add(RDF.TYPE, RDF.PROPERTY)
		.add(RDFS.LABEL, CausedByNameEN)
		.add(RDFS.LABEL, CausedByNameFR);	
		return builder;
	}
	...
	public ModelBuilder PropertyHasProcedure(ModelBuilder builder){
		...
		.add(RDF.TYPE, RDF.PROPERTY)
		.add(RDFS.LABEL, HasProcedureNameEN)
		.add(RDFS.LABEL, HasProcedureNameFR);	
		return builder;
	}
	...
	public ModelBuilder PropertyHasObservation(ModelBuilder builder){
		...
		.add(RDF.TYPE, RDF.PROPERTY)
		.add(RDFS.LABEL, HasObservationNameEN)
		.add(RDFS.LABEL, HasObservationNameFR);	
		return builder;
	}
	...
	public ModelBuilder PropertyHasDiagnosis(ModelBuilder builder){
		...
		.add(RDF.TYPE, RDF.PROPERTY)
		.add(RDFS.LABEL, HasDiagnosisNameEN)
		.add(RDFS.LABEL, HasDiagnosisNameFR);	
		return builder;
	}

	//9
	private String  HasEncounter = "CDMHPresc:has_encounter";
	private Literal HasEncounterNameEN =  Values.literal("has encouter","en");
	...
	public ModelBuilder PropertyHasEncounter(ModelBuilder builder){
		...
		.add(RDF.TYPE, RDF.PROPERTY)
		.add(RDFS.LABEL, HasEncounterNameEN)
		.add(RDFS.LABEL, HasEncounterNameFR);	
		return builder;
	}
	...
	public ModelBuilder PropertyPartOf(ModelBuilder builder){
		...
		.add(RDF.TYPE, RDF.PROPERTY)
		.add(RDFS.LABEL, PartOfNameEN)
		.add(RDFS.LABEL, PartOfNameFR);	
		return builder;
	}
	...
	public ModelBuilder PropertyHasDevice(ModelBuilder builder){
		builder.subject(HasDevice)
		.add(RDF.TYPE, RDF.PROPERTY)
		.add(RDFS.LABEL, HasDeviceNameEN)
		.add(RDFS.LABEL, HasDeviceNameFR);	
		return builder;
	}
	...
	public dataModel(String PrescriptomeModelVersion) throws RDFHandlerException, UnsupportedRDFormatException, FileNotFoundException, URISyntaxException {
